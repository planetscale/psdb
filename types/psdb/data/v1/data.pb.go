...
var file_psdb_data_v1_data_proto_rawDesc = string([]byte{
...
var (
	...
	file_psdb_data_v1_data_proto_rawDescData []byte
)

func file_psdb_data_v1_data_proto_rawDescGZIP() []byte {
	file_psdb_data_v1_data_proto_rawDescOnce.Do(func() {
		file_psdb_data_v1_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_psdb_data_v1_data_proto_rawDesc), len(file_psdb_data_v1_data_proto_rawDesc)))
	})
	return file_psdb_data_v1_data_proto_rawDescData
}

var file_psdb_data_v1_data_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_psdb_data_v1_data_proto_goTypes = []any{
...
func file_psdb_data_v1_data_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_psdb_data_v1_data_proto_rawDesc), len(file_psdb_data_v1_data_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
