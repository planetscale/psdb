...
import (
	...
	v212 "github.com/planetscale/vitess-types/gen/vitess/vtgate/v21"
...
type ExecuteRequest struct {
	...
	BindVariables map[string]*v21.BindVariable `protobuf:"bytes,3,rep,name=bind_variables,json=bindVariables,proto3" json:"bind_variables,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_psdb_v1alpha1_database_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x2f, 0x76, 0x32, 0x31, 0x2f, 0x76, 0x74, 0x67, 0x61, 0x74, 0x65, 0x2e, 0x70,
	...
	0x79, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x42, 0x69, 0x6e, 0x64, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62,
	...
	0x73, 0x73, 0x2e, 0x76, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x52, 0x50, 0x43,
	...
	0x32, 0x31, 0x2e, 0x42, 0x69, 0x6e, 0x64, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65, 0x52,
	...
	0x76, 0x32, 0x31, 0x2e, 0x52, 0x50, 0x43, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72,
...
var file_psdb_v1alpha1_database_proto_goTypes = []any{
	...
	(*v21.QueryResult)(nil),       // 13: vitess.query.v21.QueryResult
	(*v211.RPCError)(nil),         // 14: vitess.vtrpc.v21.RPCError
	(*v21.Field)(nil),             // 15: vitess.query.v21.Field
	(*v212.Session)(nil),          // 16: vitess.vtgate.v21.Session
	(*v21.BindVariable)(nil),      // 17: vitess.query.v21.BindVariable
}
var file_psdb_v1alpha1_database_proto_depIdxs = []int32{
	...
	13, // 6: psdb.v1alpha1.ExecuteResponse.result:type_name -> vitess.query.v21.QueryResult
	14, // 7: psdb.v1alpha1.ExecuteResponse.error:type_name -> vitess.vtrpc.v21.RPCError
	...
	15, // 11: psdb.v1alpha1.PrepareResponse.fields:type_name -> vitess.query.v21.Field
	14, // 12: psdb.v1alpha1.PrepareResponse.error:type_name -> vitess.vtrpc.v21.RPCError
	...
	14, // 15: psdb.v1alpha1.CloseSessionResponse.error:type_name -> vitess.vtrpc.v21.RPCError
	16, // 16: psdb.v1alpha1.Session.vitess_session:type_name -> vitess.vtgate.v21.Session
	17, // 17: psdb.v1alpha1.ExecuteRequest.BindVariablesEntry.value:type_name -> vitess.query.v21.BindVariable
	17, // 18: psdb.v1alpha1.PrepareRequest.BindVariablesEntry.value:type_name -> vitess.query.v21.BindVariable
